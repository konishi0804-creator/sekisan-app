                ...
                <div className="flex flex-col items-center justify-center space-y-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 w-full max-w-sm">
                        ...
                        <button
                            type="button"
                            onClick={open}
                            className="cursor-pointer flex-1 min-w-[140px] px-4 py-2 bg-white border border-slate-300 shadow-sm rounded-lg text-sm font-bold text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition-colors flex items-center justify-center gap-2"
                        >
